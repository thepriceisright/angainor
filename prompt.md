...
3. Check you're on the correct branch from PRD `branchName`. If not, check it out or create it from `baseBranch` (defaults to the repo's default branch if omitted).
